...
const About = () => {
    ...
    useEffect(() => {
        if (visibleSection_1) {
          animation_2.start({opacity:1,translateX:0});
        }
        if(visibleSection_2){
            animation_4.start({opacity:1,translateX:0});
        }
        if(visibleSection_3){

            animation_6.start({opacity:1,translateX:0});
        }
        if(visibleSection_4){
    ...
    return <>
       <div style={{overflow:"hidden"}} >
        ...
        <div ref={ref_3} className={classes.about_container}>
            ...
            {/* <motion.div
                key={5}
                initial={{opacity:0,translateX:-1200}}
                animate={animation_5}
            ...
            <motion.div 
                ...
                <iframe style={{marginRight:"10px",marginLeft:"10px"}} width="90%" height={400} frameborder="0" marginheight="0" marginwidth="0" src="https://maps.google.com/maps?width=100%25&amp;height=600&amp;hl=en&amp;q=1%20Grafton%20Street,%20Dublin,%20Ireland+(My%20Business%20Name)&amp;t=&amp;z=14&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"></iframe>
                    ...
                    <a href="https://www.google.com/maps/@35.2051166,33.3822757,15z" > Konum </a>
                </div>
            </motion.div>
            </AnimatePresence>
{/* 
            ...
            <div ref={ref_4} style={{display:'flex',justifyContent:'center',overflowX:'hidden'}} >
                ...
                >
                    ...
                    style={{zIndex:6}}
                        ...
                        >
                        <div className={classes.menu_link} ><Link href="#">Let&apos;s Go</Link> </div>
